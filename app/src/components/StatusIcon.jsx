...
const ICON_PATHS = {
  ...
  "merging.running": "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4",
...
export function StatusIcon({ stateKey, size = 16 }) {
  ...
  const isAnimating = stateKey.includes("running") || stateKey === "developing" || stateKey === "testing" || stateKey === "reviewing";
